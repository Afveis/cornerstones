  ...
  return <ScrollArea className="h-full w-full">
      <div className="flex flex-col items-center justify-start min-h-full p-4 pb-20 py-[24px]">
        <div className="w-full max-w-6xl">
          <CircleDiagram groups={activeIndicatorData.groups} groupCount={globalConfig.themeCount} onUpdateGroupCount={updateGlobalConfig} onUpdateGroupConfig={updateThemeConfig} onUpdateProgress={updateSliceProgress} centerImage={activeIndicatorData.centerImage} onCenterImageChange={handleCenterImageChange} />
